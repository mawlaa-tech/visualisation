   ...
   <form action="{{ route('admin.login') }}" class="d-block" method="post">
    @csrf
      ...
      <div class="form-group icon_parent">
       ...
       <input type="password" class="form-control" name="password"   placeholder="Password">
                                ...
                                <div class="form-group">
                                    <label class="chech_container">Se souvenir de moi
      ...
      <!-- <a class="registration" href="{{ route('admin.register') }}">Create new account</a><br>-->
                                    <a href=" " class="text-white"> Mot de passe Oublié !</a><br>
                                    
                                    <a class="registration" href="{{ url('/register') }}">Créer un compte</a><br>
                                    <a class="registration" href="{{ url('user/login') }}">Se Connecter en tant que utilisateur</a><br>
