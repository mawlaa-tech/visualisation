...
<html lang="en">
    ...
    <form action="{{ url('user/update/admin/'.$admins->id) }}" method="post">
        @csrf
       
        <div class="form-group icon_parent">
            <label for="uname">Username</label>
<input type="text" class="form-control" name="name" value="{{$admins->name}}"  placeholder="Full Name">
            
            <span class="icon_soon_bottom_right"><i class="fas fa-user"></i></span>
        </div>
<div class="form-group icon_parent">
            <label for="email">E-mail</label>
<input  type="email" class="form-control" name="email" value="{{$admins->email}}" placeholder="Email Address">
        ...
        <div class="form-group icon_parent">
            <label for="rtpassword">Confirmation</label>
            <input type="password" class="form-control" name="password_confirmation"  placeholder="Confirm Password">
            <span class="icon_soon_bottom_right"><i class="fas fa-unlock"></i></span>
        </div>
        <div class="form-group">
            <a href="{{url('admin/dashboard')}}" style="color:white;"> <u>Retour</u></a>
            <button type="submit" class="btn btn-blue">Modifier</button>
        </div>
    </form>
                        <div class="footer">
                        <!--    <p>Copyright &copy; 2022 <a href="https://easylearningbd.com/">OldCare</a>. All rights reserved.</p>-->
                        </div>
                    </div>
                </div>
            </div><!--/ content wrapper -->
